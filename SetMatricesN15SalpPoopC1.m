...
%%Nearly identical to the main intialization file, but for exclusively
%%Cycle 1 as it's model has a slightly different structure (mainly that
%%there were no diel migrating mesozooplankton)
Cycle=1;

% first, get the name of spreadsheet with data
sheet=['N15InverseModelNZC1.xlsx'];
workbook='NZ';
...
cskip=5;    %cols to skip before data
...
M=[M0(:,1:(neq+ngt0)),eye(nvar+1,nvar)]; %Adds additional constraints to prevent flows from being negative
...
Inputs=xlsread('InputsNZC1.xlsx','InputsNZ','D3:M38');    %loading ba and sdba
...
ba(11)=Inputs(11,Cycle*2-1);  %Macro grazing
ba(12)=Inputs(12,Cycle*2-1);  %VMMacro grazing
ba(13)=Inputs(13,Cycle*2-1);  %Salp Auto grazing
ba(14)=Inputs(14,Cycle*2-1);  %Salp Hetero grazing
ba(15)=Inputs(15,Cycle*2-1);   %Salp Pico grazing
ba(16)=Inputs(16,Cycle*2-1);   %Salp dtm grazing
ba(17)=Inputs(17,Cycle*2-1);   %Other salp grazing
ba(18)=Inputs(18,Cycle*2-1);   %Salp fecal pellet production
ba(19)=Inputs(19,Cycle*2-1);   %Bacterial production
ba(20)=Inputs(20,Cycle*2-1);   %Pinkerton Myct-Meso Consumption
ba(21)=Inputs(21,Cycle*2-1);   %Pinkerton Myct-Macro Consumption
ba(22)=Inputs(22,Cycle*2-1);   %Pinkerton Myct-VMMacro Consumption
ba(23)=Inputs(23,Cycle*2-1);   %Pinkerton Myct-Amph Consumption
ba(24)=Inputs(24,Cycle*2-1);   %Pinkerton Myct-Salp Consumption
ba(25)=Inputs(25,Cycle*2-1);   %Pinkerton Myct-Gel Consumption
ba(26)=Inputs(26,Cycle*2-1);   %Pinkerton Pisc-Myct Consumption
ba(27)=Inputs(27,Cycle*2-1);   %Pinkerton Pisc-VMMacro Consumption
ba(28)=Inputs(28,Cycle*2-1);   %Pinkerton Pisc-Amph Consumption
ba(29)=Inputs(29,Cycle*2-1);   %Pinkerton Gelativ-Salp Consumption
ba(30)=Inputs(30,Cycle*2-1);   %Pinkerton Gelativ-Gel Consumption
ba(31)=Inputs(31,Cycle*2-1);   %Pinkerton HTL-Meso Consumption
ba(32)=Inputs(32,Cycle*2-1);   %Pinkerton HTL-Macro Consumption
ba(33)=Inputs(33,Cycle*2-1);   %Pinkerton HTL-VMMacro Consumption
ba(34)=Inputs(34,Cycle*2-1);   %Pinkerton HTL-Amph Consumption
ba(35)=Inputs(35,Cycle*2-1);   %Pinkerton HTL-Salp Consumption
ba(36)=Inputs(36,Cycle*2-1);   %Pinkerton HTL-Gel Consumption
...
sdba(11)=Inputs(11,Cycle*2);  %Macro grazing
sdba(12)=Inputs(12,Cycle*2);  %VMMacro grazing
sdba(13)=Inputs(13,Cycle*2);  %Salp Auto grazing
sdba(14)=Inputs(14,Cycle*2);  %Salp Hetero grazing
sdba(15)=Inputs(15,Cycle*2);   %Salp Pico grazing
sdba(16)=Inputs(16,Cycle*2);   %Salp dtm grazing
sdba(17)=Inputs(17,Cycle*2);   %Other salp grazing
sdba(18)=Inputs(18,Cycle*2);   %Salp fecal pellet production
sdba(19)=Inputs(19,Cycle*2);   %Bacterial production
sdba(20)=Inputs(20,Cycle*2);   %Pinkerton Myct-Meso Consumption
sdba(21)=Inputs(21,Cycle*2);   %Pinkerton Myct-Macro Consumption
sdba(22)=Inputs(22,Cycle*2);   %Pinkerton Myct-VMMacro Consumption
sdba(23)=Inputs(23,Cycle*2);   %Pinkerton Myct-Amph Consumption
sdba(24)=Inputs(24,Cycle*2);   %Pinkerton Myct-Salp Consumption
sdba(25)=Inputs(25,Cycle*2);   %Pinkerton Myct-Gel Consumption
sdba(26)=Inputs(26,Cycle*2);   %Pinkerton Pisc-Myct Consumption
sdba(27)=Inputs(27,Cycle*2);   %Pinkerton Pisc-VMMacro Consumption
sdba(28)=Inputs(28,Cycle*2);   %Pinkerton Pisc-Amph Consumption
sdba(29)=Inputs(29,Cycle*2);   %Pinkerton Gelativ-Salp Consumption
sdba(30)=Inputs(30,Cycle*2);   %Pinkerton Gelativ-Gel Consumption
sdba(31)=Inputs(31,Cycle*2);   %Pinkerton HTL-Meso Consumption
sdba(32)=Inputs(32,Cycle*2);   %Pinkerton HTL-Macro Consumption
sdba(33)=Inputs(33,Cycle*2);   %Pinkerton HTL-VMMacro Consumption
sdba(34)=Inputs(34,Cycle*2);   %Pinkerton HTL-Amph Consumption
sdba(35)=Inputs(35,Cycle*2);   %Pinkerton HTL-Salp Consumption
sdba(36)=Inputs(36,Cycle*2);   %Pinkerton HTL-Gel Consumption
sdba(37:naeq)=NaN; %The d15N approximate equalities have unknown uncertainty
 
b=[be;ba];   %Recombining b vectors now that they have been set up

InEqualInputs = xlsread('InputsNZC1.xlsx','InputsNZ','D41:M72');
...
Mesobiomass=InEqualInputs(11,col);
MacroDaybiomass=InEqualInputs(12,col);
MacroNightbiomass=InEqualInputs(13,col);
Amphbiomass=InEqualInputs(14,col);
Gelbiomass=InEqualInputs(15,col);
SalpDaybiomass=InEqualInputs(16,col);
SalpNightbiomass=InEqualInputs(17,col);
Myctbiomass=InEqualInputs(18,col);
PiscivFishbiomass=InEqualInputs(19,col);
GelativFishbiomass=InEqualInputs(20,col);
HNFsize=InEqualInputs(21,col);
Flagsize=InEqualInputs(22,col);
Microsize=InEqualInputs(23,col);
Mesosize=InEqualInputs(24,col);
Macrosize=InEqualInputs(25,col);
Amphsize=InEqualInputs(26,col);
GelPredsize=InEqualInputs(27,col);
Salpsize=InEqualInputs(28,col);
Myctsize=InEqualInputs(29,col);
PiscivFishsize=InEqualInputs(30,col);
GelativFishsize=InEqualInputs(31,col);
SalpResp=InEqualInputs(32,col);
...
NonDVMBiomass=Mesobiomass;   %All hours are spent in the euphotic and contribute NH4
...
h(13)=NonDVMfactor*(NonDVMBiomass*CN*12)/1000; %Need to multiply by CN*12 for per mg C to mmolN because biomass is in units of mmol N (so umol N / day / mmolN).  Need to divide by 1000 to go from umol N / day to mmol N / day
h(14) = -6*h(13);
...
h(15)=NonDVMfactor*(NonDVMBiomass*CN*12)/1000; 
h(16) = -6*h(15);
...
h(17)=DVMfinalDay+DVMfinalNight;
h(18) = -6*h(17);
%For Amphipods
CW=Amphsize;
...
NonDVMExc=exp(a0)*exp(a1*log(CW))*exp(a2*(1000/SurfTemp))*exp(a3*log(Depth1));  
NonDVMfactor=24/14*NonDVMExc/CW;  
h(19)=NonDVMfactor*(NonDVMBiomass*CN*12)/1000; 
h(20) = -6*h(19);
...
h(21)=NonDVMfactor*(NonDVMBiomass*CN*12)/1000; 
h(22) = -6*h(21);
...
h(23)=DVMfinalDay+DVMfinalNight;
%Piscivorous fish
...
Exc=Resp/22.4/24.2;  
factor=24*Exc/(WW*.1);  
h(24)=factor*(PiscivFishbiomass*CN*12)/1000;

%Salp minimum respiration calculated using Ikeda 2014
a0=17.945;
a1=0.771;
a2=-5.528;
a3=-0.082;
...
NonDVMfactor=24/14*NonDVMExc/CW;  
NonDVMfinal=NonDVMfactor*(NonDVMBiomass*CN*12)/1000; 
DVMExcNight=exp(a0)*exp(a1*log(CW))*exp(a2*(1000/SurfTemp))*exp(a3*log(Depth1))*exp(a13);  
DVMfactorNight=12/14*DVMExcNight/CW;  
DVMfinalNight=DVMfactorNight*(DVMBiomass*CN*12)/1000; 
DVMExcDay=exp(a0)*exp(a1*log(CW))*exp(a2*(1000/DeepTemp))*exp(a3*log(Depth2))*exp(a13); 
DVMfactorDay=12/14*DVMExcDay/CW;  
DVMfinalDay=DVMfactorDay*(DVMBiomass*CN*12)/1000; 
h(25)=NonDVMfinal+DVMfinalDay+DVMfinalNight;
h(26) = -6*h(25);
...
%is the reference temperature for the Q10 being used. Mike is using the 
...
h(112)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*Flagbiomass;
%Heterotrophic Nanoflagellates
PredVol=HNFsize;
h(113)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*HNFbiomass;
%Microzoos
PredVol=Microsize;
h(114)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*MICbiomass;
...
h(115)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*Mesobiomass;
%Macro
DWC=0.4; %Dry weight to carbon conversion
WWDW = 0.2;  %Wet weight to Dryweight conversion
PredVol=Macrosize/DWC/WWDW*10^9;   %10^9 goes from mm^3 to um^3
h(116)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*MacroDaybiomass;
%VMMacro
DWC=0.4; %Dry weight to carbon conversion
WWDW = 0.2;  %Wet weight to Dryweight conversion
PredVol=Mesosize/DWC/WWDW*10^9;   
h(117)=-12*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*(MacroNightbiomass-MacroDaybiomass);
%Amphipod
DWC=0.4; %Dry weight to carbon conversion
WWDW = 0.2;  %Wet weight to Dryweight conversion
PredVol=Amphsize/DWC/WWDW*10^9;   %10^9 goes from mm^3 to um^3
h(118)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*Amphbiomass;
%Gelatinous Predators
DWC=0.4; %Dry weight to carbon conversion
WWDW = 0.2;  %Wet weight to Dryweight conversion
PredVol=GelPredsize/DWC/WWDW*10^9;   %10^9 goes from mm^3 to um^3
h(119)=-24*10^(a6+b6*log10(PredVol)+log10(2.8)*(Temp1-20)/10)*Gelbiomass;


%Capping max autotroph production to double the biomass
h(120)=-2*Picobiomass;  %Cyano max production at double biomass
h(121)=-2*Diatombiomass;  %Diatom max production at double biomass
h(122)=-2*Flagbiomass;  %Flag max production at double biomass
...
d15NInputs=xlsread('InputsNZC1.xlsx','InputsNZ','D75:M77');
